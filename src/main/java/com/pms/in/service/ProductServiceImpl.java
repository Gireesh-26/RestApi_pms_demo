...
import com.pms.in.exception.ProductNotFoundException;
...
public class ProductServiceImpl implements ProductService {
	...
	public Product getProduct(Integer pid) {
		...
		return productRepository.findById(pid).orElseThrow(()->new ProductNotFoundException("Product with ID:"+pid+" Not available!"));
		//return productRepository.findById(pid).orElseThrow(()->new ProductNotFoundException("Product with Id: "+pid+""))
	}
